...
export class RegisterComponent {
  ...
  public signUp() {
    if(this.userService.checkVoidsRegister(this.user) && this.userService.checkValuesRegister(this.user) && this.userService.checkLengthPassword(this.user) && this.userService.comparePasswords(this.user))
